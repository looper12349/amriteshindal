    ...
    return (
        <div id="work" className="mt-10 relative">
            ...
            <Div className="mb-10">
                ...
                Explore my latest projects showcasing a diverse range of digital solutions,
                including <br/>dynamic dashboards, intuitive mobile applications, and sleek websites
                </div>
            </Div>
            {/* SECTION HEADING END */}
