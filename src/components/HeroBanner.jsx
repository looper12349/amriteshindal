...
const HeroBanner = () => {
    ...
    return (
        <div
            id="hero"
            className="w-full h-[135vh] relative bg-[#111111] overflow-hidden"
        >
            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>amriteshindal29@gmail.com</div>
                    </div>
                ...
                >
                    <h1 className="text-[50px] md:text-[120px] 2xl:text-[159px] leading-[50px] md:leading-[125px]  2xl:leading-[192px] font-oswald uppercase">
                        I Am A Full Stack
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Amritesh Indal</span>
                    </div>
                    <div className="max-w-[510px]">
                    A passionate Full Stack Developer with a keen eye for crafting robust, user-centric web applications. With a blend of creativity and technical expertise, I thrive in translating ideas into seamless digital experiences. 
                    </div>
                </motion.div>
                {/* INTRO END */}
